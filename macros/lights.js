...
// Adds toggle for Has Vision
// Removes furnace dependency
  ...
  new Dialog({
    ...
    close: html => {
      if (applyChanges) {
        ...
        let vision = html.find('[name="vision"]').is(":checked");
